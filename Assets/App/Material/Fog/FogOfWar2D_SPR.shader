Shader "Custom/FogOfWar2D_Blizzard_Sprite"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f
            {
                ...
                float2 maskUv   : TEXCOORD1; // cercles (0–1 plein écran)
            };
            ...
            v2f vert (appdata v)
            {
                ...
                // UV pour la texture de bruit : prend en compte le Tiling du material
                o.texUv  = TRANSFORM_TEX(v.uv, _NoiseTex);

                // UV 0–1 pour le masque (trous de vision)
                o.maskUv = v.uv;
